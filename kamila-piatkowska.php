...
<html>
    <head lang="pl-PL">
        <meta charset="UTF-8">
        <!--Page Title-->
        <title>Kamila Piątkowska | Konwersatorium Muzyczne</title>
                ...
                <div class="row clearfix">
                    <div class="col-1">
                        <div class="section-heading">
                            ...
                            <h2 class="section-title">Kamila Piątkowska</h2>
                        </div>
                    </div>
                    <div class="col-3">
                        <p><img src="/images/user-images/kamilaw.jpg" alt="Kamila Piątkowska" class="topMargin"></p>
                    </div>
                    <div class="col-3">
