...
<html>
    <head lang="en">
        <meta charset="UTF-8">
        <!--Page Title-->
        <title>Pierwsze kroki | Konwersatorium Muzyczne</title>
                    ...
                    <div class="row clearfix">
                        <div class="col-3">
                            <div class="section-heading">
                                <h3>FOR SMALL CHILDREN</h3>
                                <h2 class="section-title">First steps</h2>
                            </div>
                            <p><img src="images/oferta/umuzykalnienie.jpg" /></p>
                        </div>
                        <div class="col-2-3 alignToPhoto">
						    <p>Individual music classes based on a master-pupil system for children 4+.</p>
