...
<html>
    <head lang="en">
        <meta charset="UTF-8">
        <!--Page Title-->
        <title>Oferta | Konwersatorium Muzyczne</title>
                    ...
                    <div class="row clearfix">
                        <div class="col-3">
                            <div class="section-heading">
                                <h3>OFERTA</h3>
                                <h2 class="section-title">Co możemy Tobie zaproponować?</h2>
                                <p class="section-subtitle">Mamy różne programy zależnie od wieku.</p>
                            </div>
                        </div>
                        <div class="col-2-3">
                            <div>
                                <h3>Posiadamy trzy programy nauczania:</h3>
                                <ul>
                                    <li>Program dla najmłodszych – Pierwsze kroki 2-3 lata</li>
                                    <li>Program dla uczniów 4-18 lat</li>
                                    <li>Program dla dorosłych</li>
                                </div>
                            </div>
                        </div>
                    </section>
