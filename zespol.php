                    ...
                    <div class="row clearfix">
                        <div class="col-3">
                            <div class="section-heading">
                                <h3>DLA DZIECI I DOROSŁYCH</h3>
                                <h2 class="section-title">Chór i Zespół wokalny</h2>
                                <p><img src="/images/oferta/zespol.jpg" /></p>
                            </div>
                        </div>
                        <div class="col-2-3 alignToPhoto">
                            <p><b>NOWOŚĆ! ZAPISZ SIĘ JUŻ TERAZ NA PAŹDZIERNIK 2019<br>Liczba miejsc ograniczona. Zacznij śpiewać i spełnij marzenia. Zapisy i informacje 883 489 184</b><br><br>Lekcje śpiewu w kameralnych grupach. Posiadamy specjalny autorski program nauczania dla osób dorosłych pod podstaw.</p>
