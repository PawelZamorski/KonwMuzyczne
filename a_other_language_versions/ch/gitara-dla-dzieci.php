...
<html>
    <head lang="en">
        <meta charset="UTF-8">
        <!--Page Title-->
        <title>Gitara dla dzieci | Konwersatorium Muzyczne</title>
                    ...
                    <div class="row clearfix">
                        <div class="col-3">
                            <div class="section-heading">
                                <h3>FOR CHILDREN</h3>
                                <h2 class="section-title">Guitar Class</h2>
                                <p><img src="images/oferta/gitara-dla-dzieci.jpg" /></p>
                            </div>
                        </div>
                        <div class="col-2-3 alignToPhoto">
                            <p>Individual classic guitar classes based on a master-pupil system.</p>
                            ...
                            <p>During a lesson, pupils learn new music sheets, what supports development of their analytical skills, notes interpretations, and faster tablature evaluation. How to overcome challenges? How to see similarities in a music piece? How to interpret unknown musical elements? Music lessons help pupils master skills of logical thinking.
                            </p>
