                ...
                <section id="about" class="introduction scrollto">
                    <div class="row clearfix">
                        ...
                        <div class="col-2-3 alignToPhoto">
                            <p>Individual lessons based on the pupil-master system. A specially designed programme of teaching adults from beginning.</p>
                            ...
                            <p> Lessons are available in Polish or English language</p>
                        </div>
                    </section>
                    <!--End of Introduction-->
                    <!--Footer-->
