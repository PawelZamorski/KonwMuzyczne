                    ...
                    <div class="row clearfix">
                        <div class="col-3">
                            <div class="section-heading">
                                <h3>DLA DOROSŁYCH</h3>
                                <h2 class="section-title">Program Meloman</h2>
                                <p><img src="/images/oferta/meloman.jpg" /></p>
                            </div>
                        </div>
                        <div class="col-2-3 alignToPhoto">
                            <p>Indywidualne zajęcia dla osób dorosłych, chcących rozwijać swoją wiedzę muzyczna bez konieczności nauki gry na instrumencie.</p>
						...
						<p><b>ZAPISZ SIĘ JUŻ TERAZ!<br>Liczba miejsc ograniczona. Zacznij dziś i spełnij marzenia. Zapisy i informacje 883 489 184</b></p>
