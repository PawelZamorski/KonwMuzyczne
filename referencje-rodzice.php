...
<html>
    <head lang="pl-PL">
        <meta charset="UTF-8">
        <!--Page Title-->
        <title>Referencje rodziców | Konwersatorium Muzyczne</title>
                    ...
                    <div class="row clearfix">
                        <div class="col-3">
                            <div class="section-heading">
                                <h3>REFERENCJE RODZICÓW</h3>
                                <h2 class="section-title">Dziękujemy za zaufanie!</h2>
                                <p class="section-subtitle">Można tutaj poznać historie zadowolonych rodziców, których dzieci kształciły się w Konwersatorium Muzycznym.</p>
                            </div>
                        </div>
                        <div class="col-2" id="rodzice">
						<iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fgosia.jakubowska%2Fposts%2F10158054037115535&width=500" width="500" height="219" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
