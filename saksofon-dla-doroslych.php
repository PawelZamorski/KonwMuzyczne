...
<html>
    <head lang="pl-PL">
        <meta charset="UTF-8">
        <!--Page Title-->
        <title>Saksofon dla dorosłych | Konwersatorium Muzyczne</title>
                    ...
                    <div class="row clearfix">
                        <div class="col-3">
                            <div class="section-heading">
                                <h3>DLA DOROSŁYCH</h3>
                                <h2 class="section-title">Klasa saksofonu</h2>
                                <p><img src="/images/oferta/saksofon-dla-doroslych.jpg" /></p>
                            </div>
                        </div>
                        <div class="col-2-3 alignToPhoto">
                            <p>Indywidualne lekcje gry na saksofonie w systemie mistrz-uczeń. Posiadamy specjalny autorski program nauczania dla osób dorosłych pod podstaw.</p>
							<p><b>ZAPISZ SIĘ JUŻ TERAZ!<br>Liczba miejsc ograniczona. Zacznij grać i spełnij marzenia. Zapisy i informacje 883 489 184</b></p>
						...
						<p>Zajęcia online są dostępne z uwzględnieniem występujących różnic czasu. Zajęcia przeznaczone są zarówno dla osób dorosłych początkujących, jak też dla już grających i zaawansowanych. Materiały do nauki – nuty przesyłamy mejlem. Zajęcia odbywają się online indywidualnie – na żywo w uzgodnionym terminie. Lekcje są dostępne w języku polskim i angielskim.</p>
                            ...
                            <ul>
                                <li>utworów klasycznych
                                </li>
                                <li>jazzu, blues, rock’n’roll
                                </li>
                                <li>przebojów zespołów takich jak The Beatles i Abba
                                </li>
                            ...
                            <p>W szkole posiadamy saksofon, więc na lekcje nie trzeba przynosić własnego – jest to komfortowe rozwiązanie. Przez pierwszy miesiąc próbny nie trzeba posiadać w domu instrumentu.</p>
                        </div>
                    </section>
                    <!--End of Introduction-->
                    <!--Footer-->
