...
<html>
    <head lang="pl-PL">
        <meta charset="UTF-8">
        <!--Page Title-->
        <title>Gitara dla dorosłych | Konwersatorium Muzyczne</title>
                ...
                <div class="row clearfix">
                    <div class="col-3">
                        <div class="section-heading">
                            <h3>DLA DOROSŁYCH</h3>
                            <h2 class="section-title">Klasa gitary</h2>
                            <p><img src="/images/oferta/gitara-dla-doroslych.jpg" /></p>
                        </div>
                    </div>
                    <div class="col-2-3 alignToPhoto">
                        <p>Indywidualne lekcje gry na gitarze klasycznej w systemie mistrz-uczeń. Posiadamy specjalny autorski program nauczania dla osób dorosłych pod podstaw.</p>
                        ...
                        <p>W szkole posiadamy gitarę, więc na lekcje nie trzeba przynosić własnej – jest to komfortowe rozwiązanie. Przez pierwszy miesiąc nie trzeba posiadać w domu instrumentu.</p>
                    </ul>
                </div>
            </section>
            <!--End of Introduction-->
