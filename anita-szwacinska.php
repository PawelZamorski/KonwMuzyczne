...
<html>
    <head lang="pl-PL">
        <meta charset="UTF-8">
        <!--Page Title-->
        <title>Anita Szwacińska | Konwersatorium Muzyczne</title>
                ...
                <div class="row clearfix">
                    <div class="col-1">
                        <div class="section-heading">
                            <h3>Klasa śpiewu</h3>
                            <h2 class="section-title">Anita Szwacińska</h2>
                        </div>
                    </div>
                    <div class="col-3">
                        <p><img src="/images/user-images/anita.jpg" alt="Anita Szwacińska" class="topMargin"></p>
                    </div>
                    <div class="col-3">
