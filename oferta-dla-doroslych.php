...
<html>
    <head lang="pl-PL">
        <meta charset="UTF-8">
        <!--Page Title-->
        <title>Oferta dla dorosłych | Konwersatorium Muzyczne</title>
                    ...
                    <div class="row clearfix">
                        <div class="col-3">
                            <div class="section-heading">
                                ...
                                <p><img src="/images/oferta/fortepian-dorosli.jpg" /></p>
                            </div>
                        </div>
                        <div class="col-2-3 alignToPhoto">
                            <p>Indywidualne lekcje gry na fortepianie w systemie mistrz-uczeń. Posiadamy specjalny autorski program nauczania dla osób dorosłych pod podstaw.</p>
