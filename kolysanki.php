                    ...
                    <div class="row clearfix">
                        <div class="col-3">
                            <div class="section-heading">
                                <h3>KOŁYSANKI</h3>
                                <h2 class="section-title">Kołysanki-śpiewanki</h2>
                                <p><img src="/images/oferta/kolysanki.jpg" /></p>
                            </div>
                        </div>
                        <div class="col-2-3 alignToPhoto">
                            <p>Indywidualne lekcje śpiewu dla dorosłych</p>
						...
						<p>Zajęcia online są dostępne z uwzględnieniem występujących różnic czasu. Zajęcia przeznaczone są zarówno dla osób dorosłych początkujących, jak też dla już śpeiwających i zaawansowanych. Materiały do nauki – nuty przesyłamy mejlem. Zajęcia odbywają się online indywidualnie – na żywo w uzgodnionym terminie. Lekcje są dostępne w języku polskim i angielskim.</p>
                            ...
                            <p>Dodatkowo elementy muzykoterapii pomagają w radzeniu sobie z napięciami i stresami dnia codziennego. Ćwiczenia z instrumentami podczas słuchania wybranych fragmentów muzyki (nie tylko klasycznej) maja działanie relaksujące, wzmacniające poczucie radości oraz satysfakcji z życia, zarówno u matki jak i jej dziecka.</p>
                        </div>
                    </section>
                    <!--End of Introduction-->
                    <!--Footer-->
