...
--
-- Host: MySQL-5.1
-- Generation Time: 06 Wrz 2020, 16:26
...
(2, 2, 5, '/images/oferta/gordonki.jpg', 2, '/images/oferta-ikony/gordonki.jpg', 'https://www.youtube.com/embed/r6ThuFthhsE?&rel=0'),
(3, 3, 3, '/images/oferta/logopedia.jpg', 3, '/images/oferta-ikony/logopedia.jpg', 'https://www.youtube.com/embed/r6ThuFthhsE?&rel=0'),
(4, 4, 2, '/images/oferta/fortepian-dzieci.jpg', 4, '/images/oferta-ikony/fortepian-dzieci.jpg', 'https://www.youtube.com/embed/b4h8Ot88kcA?&rel=0'),
...
(15, 10, 1, '/images/oferta/zespol.jpg', 14, '/images/oferta-ikony/zespol.jpg', 'https://www.youtube.com/embed/r6ThuFthhsE?&rel=0'),
...
CREATE TABLE IF NOT EXISTS `main_contact_details_translation` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `languages_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `shop_item_category_translation` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `languages_id` int(10) unsigned NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `languages_id` (`languages_id`),
  KEY `shop_item_category_id` (`shop_item_category_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `shop_item_details_translation` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `languages_id` int(10) unsigned NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `languages_id` (`languages_id`),
  KEY `shop_item_details_id` (`shop_item_details_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=11 ;
...
CREATE TABLE IF NOT EXISTS `shop_item_main_translation` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `languages_id` int(10) unsigned NOT NULL,
  `heading_3` varchar(255) DEFAULT NULL,
  `heading_2` varchar(255) DEFAULT NULL,
