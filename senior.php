...
<head lang="pl-PL">
	<meta charset="UTF-8">
	<!--Page Title-->
	<title>Konwersatorium Muzyczne w Warszawie</title>
	...
	<meta name="description" content="Kreatywna szkoła rozbudzająca miłość do muzyki dla dzieci i dorosłych. Zapraszamy!">
				...
				<div class="row clearfix">
					<div class="col-3">
						<div class="section-heading">
							<h3>ZAPRASZAMY</h3>
							<h2 class="section-title">Lekcje indywidualne dla Seniorów</h2>
							<p><img src="/images/oferta/senior-duzy.jpg" /></p>
						</div>
					</div>
					<div class="col-2-3 alignToPhoto">
					<p><b>Lekcje prowadzimy w secesyjnej kamienicy w centrum Warszawy, a teraz także online – zajęcia dostępne w całej Polsce oraz na świecie.</b></p>
						<p><b>Trwają zapisy. Liczba miejsc ograniczona. Zapisy i informacje 883 489 184</b></p>
						
						<p>Spełnij marzenie! Zawsze chciałeś grać? Nie było czasu? Zabrakło możliwości? Zapraszamy na nowy program nauki gry dedykowany dla osób 50+. Nasi słuchacze mają 60+, 70+ i nawet 80+ bo nigdy nie jest za późno aby rozpocząć przygodę z muzyką.</p>
				...
				<div class="row clearfix">
					...
					<div class="pricing-block col-3 wow fadeInUp" data-wow-delay="0.8s">
						<div class="pricing-block-content">
							<h3>Fortepian</h3>
							<p class="pricing-sub">dla dorosłych 50+</p>
							<span><a href="oferta-dla-doroslych.html"><img src="/images/oferta-ikony/fortepian-dorosli.jpg" /></a></span>
							<a href="oferta-dla-doroslych.html" class="button">Sprawdź</a>
						</div>
					</div>
					<div class="pricing-block col-3 wow fadeInUp" data-wow-delay="0.8s">
						<div class="pricing-block-content">
							<h3>Śpiew</h3>
							<p class="pricing-sub">dla dorosłych 50+</p>
							<span><a href="spiew-dla-doroslych.html"><img src="/images/oferta-ikony/spiew-dorosli.jpg" /></a></span>
							<a href="spiew-dla-doroslych.html" class="button">Sprawdź</a>
						</div>
					</div>
					<div class="pricing-block col-3 wow fadeInUp" data-wow-delay="0.8s">
						<div class="pricing-block-content">
							<h3>Gitara</h3>
							<p class="pricing-sub">dla dorosłych 50+</p>
							<span><a href="gitara-dla-doroslych.html"><img src="/images/oferta-ikony/gitara-dorosli.jpg" /></a></span>
							<a href="gitara-dla-doroslych.html" class="button">Sprawdź</a>
						</div>
					</div>
					<div class="pricing-block col-3 wow fadeInUp" data-wow-delay="0.4s">
						<div class="pricing-block-content">
							<h3>Wiolonczela</h3>
							<p class="pricing-sub">dla dorosłych 50+</p>
							<span><a href="wiolonczela-dla-doroslych.html"><img src="/images/oferta-ikony/wiola-dorosli.jpg" /></a></span>
							<a href="wiolonczela-dla-doroslych.html" class="button">Sprawdź</a>
						</div>
					</div>
					<div class="pricing-block featured col-3 wow fadeInUp" data-wow-delay="0.6s">
						<div class="pricing-block-content">
							<h3>Saksofon</h3>
							<p class="pricing-sub">dla dorosłych 50+</p>
							<span><a href="saksofon-dla-doroslych.html"><img src="/images/oferta-ikony/saksofon-dorosli.jpg" /></a></span>
							<a href="saksofon-dla-doroslych.html" class="button">Sprawdź</a>
						</div>
					</div>
					<div class="pricing-block featured col-3 wow fadeInUp" data-wow-delay="0.6s">
						<div class="pricing-block-content">
							<h3>Chór i Zespół wokalny</h3>
							<p class="pricing-sub">dla dorosłych 50+</p>
							<span><a href="zespol.html"><img src="/images/oferta-ikony/zespol.jpg" /></a></span>
							<a href="zespol.html" class="button">Sprawdź</a>
						</div>
					</div>
					<div class="pricing-block col-3 wow fadeInUp" data-wow-delay="0.4s">
						<div class="pricing-block-content">
							...
							<p class="pricing-sub">dla dorosłych 50+</p>
							<span><a href="retoryka.html"><img src="/images/oferta-ikony/retoryka.jpg" /></a></span>
							<a href="retoryka.html" class="button">Sprawdź</a>
						</div>
					</div>
					<div class="pricing-block col-3 wow fadeInUp" data-wow-delay="0.4s">
						<div class="pricing-block-content">
							<h3>Musicfulness</h3>
							<p class="pricing-sub">dla dorosłych 50+</p>
							<span><a href="musicfulness.html"><img src="/images/oferta-ikony/musicfulness.jpg" /></a></span>
							<a href="musicfulness.html" class="button">Sprawdź</a>
						</div>
					</div>
					<div class="pricing-block col-3 wow fadeInUp" data-wow-delay="0.4s">
						<div class="pricing-block-content">
							<h3>Meloman</h3>
							<p class="pricing-sub">dla dorosłych 50+</p>
							<span><a href="program-meloman.html"><img src="/images/oferta-ikony/meloman.jpg" /></a></span>
							<a href="program-meloman.html" class="button">Sprawdź</a>
						</div>
					</div>
					<div class="pricing-block col-3 wow fadeInUp" data-wow-delay="0.8s">
					</div>
